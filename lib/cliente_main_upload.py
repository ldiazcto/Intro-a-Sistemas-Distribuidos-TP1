...
def main():
    ...
    sender_goback = sender_gobackn.GoBackN("localhost", 12000,"lp_desde_cliente.pdf", "/Users/abrildiazmiguez/Desktop/Intro_a_Distr/Intro-a-Sistemas-Distribuidos-TP1/lib/BDD_Cliente")
    sender_goback.enviar_archivo()
